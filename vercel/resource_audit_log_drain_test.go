		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("vercel_audit_log_drain.test", "http.endpoint", "https://verify-test-rouge.vercel.app/api"),
					resource.TestCheckResourceAttr("vercel_audit_log_drain.test", "http.encoding", "json"),
					resource.TestCheckResourceAttr("vercel_audit_log_drain.test", "http.compression", "gzip"),
					resource.TestCheckResourceAttr("vercel_audit_log_drain.test", "http.headers.%", "1"),
