	...
	return schema.ListNestedAttribute{
		...
		NestedObject: schema.NestedAttributeObject{
			Attributes: map[string]schema.Attribute{
				...
				"public_key_jwk":         schema.StringAttribute{Computed: true, Description: "The public key as a JSON-encoded JWK."},
				"public_key_fingerprint": schema.StringAttribute{Computed: true, Description: "The fingerprint of the public key."},
				"public_key_pem":         schema.StringAttribute{Computed: true, Description: "The public key in SPKI PEM form."},
				"certificate_pem":        schema.StringAttribute{Computed: true, Description: "The key's self-signed X.509 certificate in PEM form."},
